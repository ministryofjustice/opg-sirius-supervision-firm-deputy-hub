(() => {
      ...
      4: function (t, e, n) {
        !(function (t) {
          ...
          (function (t) {
            ...
            function (t) {
              ...
              ("DOMTokenList" in this &&
                ...
                "classList" in (o = document.createElement("span")) &&
                  (o.classList.toggle("x", !1),
                  o.classList.contains("x") &&
                    (o.classList.constructor.prototype.toggle = function (e) {
                      var n = arguments[1];
                      if (n === t) {
              ...
              e(
                ...
                function (t, e) {
                  ...
                  this.initHeaderAttributes(n, e),
                    ...
                    n.addEventListener(
                      "click",
                      this.onSectionToggle.bind(this, t)
                    ),
            ...
            (o.prototype.setExpanded = function (t, e) {
              e
                .querySelector("." + this.sectionButtonClass)
            ...
            (o.prototype.checkIfAllSectionsOpen = function () {
              return (
                ...
                this.$module.querySelectorAll("." + this.sectionExpandedClass)
                  .length
              );
            }),
                            ...
                            function () {
                              ...
                              e._events &&
                                ...
                                e._events[n].list.length ||
                                  (e.detachEvent &&
                                    e.detachEvent("on" + n, e._events[n]),
                                  delete e._events[n]));
                            }),
          ...
          function d(t) {
            (this.$module = t),
              (this.$menuButton =
                t && t.querySelector(".govuk-js-header-toggle")),
              (this.$menu =
                this.$menuButton &&
                t.querySelector(
          ...
          (s.prototype.init = function () {
            ...
            (s.prototype.polyfillDetails = function () {
              ...
              n &&
                ...
                this.polyfillHandleInputs(
                  n,
                  this.polyfillSetAttributes.bind(this)
                ));
            }),
            ...
            (s.prototype.polyfillHandleInputs = function (t, e) {
            ...
            (a.prototype.updateCountMessage = function () {
              var t = this.$textarea,
                ...
                i = this.maxLength,
                r = i - o;
              (i * (e.threshold ? e.threshold : 0)) / 100 > o
            ...
            (c.prototype.syncConditionalRevealWithInputState = function (t) {
              var e = this.$module.querySelector(
            ...
            (c.prototype.unCheckAllInputsExcept = function (t) {
              e(
            ...
            (c.prototype.unCheckExclusiveInputs = function (t) {
              e(
                document.querySelectorAll(
            ...
            (l.prototype.focusTarget = function (t) {
              ...
              return (
                !!o && (o.scrollIntoView(), n.focus({ preventScroll: !0 }), !0)
              );
            }),
              ...
              if (e) {
                ...
                if (n.length) {
                  ...
                  if (
                    r.height &&
                    window.innerHeight &&
                    r.top + r.height - i < window.innerHeight / 2
                  )
                    return o;
                }
              }
            ...
            (d.prototype.handleMenuButtonClick = function () {
              var t = this.$menu.classList.toggle(
                "govuk-header__navigation--open"
              );
              this.syncState(t);
            }),
            ...
            (t.initAll = function (t) {
              var n =
                void 0 !== (t = void 0 !== t ? t : {}).scope
                  ? t.scope
                  : document;
              e(
                n.querySelectorAll('[data-module="govuk-button"]'),
                function (t) {
                  new r(t).init();
                }
              ),
                ...
                e(
                  n.querySelectorAll('[data-module="govuk-details"]'),
                  function (t) {
                    new s(t).init();
                  }
                ),
                ...
                new l(
                  n.querySelector('[data-module="govuk-error-summary"]')
                ).init(),
                new d(n.querySelector('[data-module="govuk-header"]')).init(),
                e(
                  n.querySelectorAll(
                ...
                e(
                  n.querySelectorAll('[data-module="govuk-radios"]'),
                  function (t) {
                    new h(t).init();
                  }
                ),
                e(
                  n.querySelectorAll('[data-module="govuk-tabs"]'),
                  function (t) {
                    new p(t).init();
                  }
                );
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      n.n(t)().initAll(),
        document
          .querySelector(".app-main-class")
          .querySelectorAll('[data-module="moj-banner-auto-hide"]')
          .forEach((t) => {
            setTimeout(function () {
